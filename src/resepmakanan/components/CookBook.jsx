	...
	render() {
		...
		return (
		  <div className="CookBook">
			  {/* <RecipeMenu /> */}
			  <Header as="h1" color="orange" textAlign="center">Resep Makanan</Header>
			  <div className="CookBook-content">
				...
				<section className="CookBook-main">
					<Header 
						...
						color="teal"
					>
						{!isRandom ? (recipes.length < 1 ? "Makanan untuk hari ini" : `About ${recipes.length} results found`) : "Tertarik?"}
					</Header>					
